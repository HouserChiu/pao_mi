...
def get_two_cate(one_cate_id):
    ...
    two_cate_id = two_cate_json['list'][0]['type']
    return two_cate_id
...
def main():
    for one_cate_id in [323, 26, 34, 939, 379, 873, 227, 25, 863, 36, 874, 892, 37, 33, 927, 35, 979, 24, 27, 902]:
        two_cate_id = get_two_cate(one_cate_id)
        get_detail(two_cate_id)
